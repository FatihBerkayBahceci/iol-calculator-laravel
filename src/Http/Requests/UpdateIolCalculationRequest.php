...
class UpdateIolCalculationRequest extends FormRequest
{
    /**
    ...
    public function rules(): array
    {
        return [
            ...
            'examination_id' => 'sometimes|nullable|exists:patient_examinations,id',
            'calculation_date' => 'sometimes|required|date|before_or_equal:today',
            'clinic_id' => 'sometimes|required|exists:clinics,id',
            'doctor_id' => 'sometimes|required|exists:users,id',
            
            // Biometri verileri
            'axial_length_right' => 'sometimes|required|numeric|min:18|max:35',
            'axial_length_left' => 'sometimes|required|numeric|min:18|max:35',
            'k1_right' => 'sometimes|required|numeric|min:35|max:50',
            'k1_left' => 'sometimes|required|numeric|min:35|max:50',
            'k2_right' => 'sometimes|required|numeric|min:35|max:50',
            'k2_left' => 'sometimes|required|numeric|min:35|max:50',
            'acd_right' => 'sometimes|required|numeric|min:2|max:5',
            'acd_left' => 'sometimes|required|numeric|min:2|max:5',
            
            // Algoritma seçimi
            'algorithm_used' => 'sometimes|required|in:SRK/T,Hoffer Q,Holladay 1,Holladay 2,Haigis,Barrett Universal II',
            'lens_constant' => 'sometimes|required|numeric|min:100|max:130',
            
            // Hesaplama sonuçları
            'iol_power_right' => 'sometimes|nullable|numeric|min:-10|max:40',
            'iol_power_left' => 'sometimes|nullable|numeric|min:-10|max:40',
            'predicted_refraction_right' => 'sometimes|nullable|numeric|min:-10|max:10',
            'predicted_refraction_left' => 'sometimes|nullable|numeric|min:-10|max:10',
            
            // Lens önerisi
            'recommended_lens_model' => 'sometimes|nullable|string|max:100',
            'recommended_lens_manufacturer' => 'sometimes|nullable|string|max:100',
            'lens_notes' => 'sometimes|nullable|string|max:500',
            
            // Doğrulama
            'is_verified' => 'sometimes|nullable|boolean',
            'verified_by' => 'sometimes|nullable|exists:users,id',
            'verification_date' => 'sometimes|nullable|date|before_or_equal:today',
            'verification_notes' => 'sometimes|nullable|string|max:500',
            
            // Notlar
            'notes' => 'sometimes|nullable|string|max:1000',
            'status' => 'sometimes|nullable|in:draft,calculated,verified,implemented',
        ];
    }
